...
def create_nonogram(nonogram_service: NonogramService):
...
def solve_nonogram(nonogram_service: NonogramService):
    data = request.get_json()
    rows = data.get('rows')
    cols = data.get('cols')
...
def get_nonogram(nonogram_service: NonogramService):
